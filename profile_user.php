...
<body>
    <div class="profile">
    <img id="avatar" src="/assets/pictures/default_avatar.png" alt="Profile Picture" height=>
    ...
    <img id="editbutton" src="assets\icons\edit-regular.svg" onclick="openImg()" height="24px"> 
    </div>
    ...
    <p class="medium">Wishlist</p>
        <div class="offerexample">
            ...
            <ul class="list mini">
                <li id="city">City</li>
                <li id="dot"><img src="..\assets\icons\circle-solid.svg" height="6px"></li>
