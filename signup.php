...
<head>
    ...
    <link rel="stylesheet" href="./stylesheets/signup.scss">
        ...
        <div class="mainbox row"> <!-- this is the white box -->
            ...
            <div class="col-sm-6 row">
                ...
                <div class="col-sm-7"> <!-- date of birth field -->
                    <label for="mailtbx" class="tbxindicator small" style="margin-top:28.12%;">Your Birthday</label> 
                ...
                <label for="mailtbx" class="tbxindicator small" style="margin-top:40.91%;">Your Birthday</label>
