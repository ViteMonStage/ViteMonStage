              ...
              <div class="tab-pane fade small" id="accepted-list-1" role="tabpanel" aria-labelledby="list-1-list">
                <div class="s_result">
                  <div class="in_desc">
                    ...
                    <h4 class="mini">Evreux (27000) - Publication 04/05/2022 - IT</h4>
                    <div class="progress">
                      <div class="progress-bar progress-bar progress-bar progress-bar-success" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">All steps are completed</div>
                    </div>
                  </div>
                  <div class="in_logo">
                    <div>
